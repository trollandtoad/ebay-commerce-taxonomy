...
class Error implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    protected static $openAPITypes = [
        ...
        'parameters' => '\eBay\Commerce\Taxonomy\Model\ErrorParameter[]',
        'subdomain' => 'string'
    ];
     ...
     * Gets parameters
     *
     * @return \eBay\Commerce\Taxonomy\Model\ErrorParameter[]|null
     */
     ...
     * Sets parameters
     *
     * @param \eBay\Commerce\Taxonomy\Model\ErrorParameter[]|null $parameters An array of name/value pairs that describe details the error condition. These are useful when multiple errors are returned.
     *
     * @return self
     */
